...
function renderTree(node: INestNode, dimsInRow: IField[], depth: number, cellRows: ReactNode[][], meaNumber: number, onHeaderCollapse: (node: INestNode) => void, enableCollapse: boolean) {
    ...
    cellRows[cellRows.length - 1].push(
        <td
            ...
            className={`bg-zinc-50 dark:bg-zinc-800 text-gray-800 dark:text-gray-100 align-top whitespace-nowrap p-2 text-xs m-1 border border-gray-300`}
            ...
            for (let row of cellRows) {
                ans.push([
                    ...
                    <td
                        ...
                        className="bg-zinc-50 dark:bg-zinc-800 text-gray-800 dark:text-gray-100 whitespace-nowrap p-2 text-xs m-1 border border-gray-300"
                    >
